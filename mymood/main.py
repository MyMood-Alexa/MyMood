...
def assessment():
    ...
    # possible responses
    responses = {'-1': "I encountered a problem. You will have to start over. Sorry for the inconvenience",
                 '1': "Are you in a depressed, elevated, or irritable mood?",
                 '2': "Are you suffering from a general medical condition with physiological effects?",
                 '3': "Are you taking any drugs or medication?",
                 '4': "Have you been impaired or hospitalized while being irritable for over a week?",
                 '5': "Have others noticed you being irritable for four or more days?",
                 '6': "Have you experienced depression or loss of interest unrelated to a recent death for two weeks or more?",
                 '7': "Have you been depressed or irritable everyday for one week or more?",
                 '8': "Do you see or hear things that are not real when you are not depressed nor irritable?",
                 '9': "Have you been experiencing these delusions or hallucinations for at least two weeks before feeling depressed or irritable?",
                 ...
                 '18': "not otherwise specified bipolar disorder superimposed on a psychotic disorder",
                 ...
                 '24': "not otherwise specified depressive disorder superimposed on a psychotic disorder",
    ...
    if (session.attributes["assess_step"] == "0"):
        ...
        if (session.attributes["assess_response"] == "yes"):
            ...
            session.attributes["assess_step"] = "-1"
        if (session.attributes["assess_manic"] == "yes" or session.attributes["assess_mixed"] == "yes"):
            session.attributes["assess_step"] = "8"
        else:
            if (session.attributes["assess_hypomanic"] == "yes" and session.attributes["assess_major_dep"] == "yes"):
        ...
        if (session.attributes["assess_response"] == "yes"):
            ...
            if (session.attributes["assess_manic"] == "yes" or session.attributes["assess_hypomanic"] == "yes"):
        ...
        if (session.attributes["assess_response"] == "yes"):
            ...
            if (session.attributes["assess_manic"] == "yes" or session.attributes["assess_hypomanic"] == "yes" or session.attributes["assess_major_dep"] == "yes" or session.attributes["assess_mixed"] == "yes"):
