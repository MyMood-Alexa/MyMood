...
def find_nearby_help():
    ...
    geocodeURL = ("https://maps.googleapis.com/maps/api/geocode/json?"
                  "address={}&key={}".format(location, key))
    ...
    if latlng_req.status_code == 200:
        ...
        radius = 24000
        placesURL = ("https://maps.googleapis.com/maps/api/place/nearbysearch/"
                     "json?location={}&radius={}&keyword={}&key={}"
                     .format(latlng, radius, keyword, key))
        ...
        if places_req.status_code == 200:
            ...
            if details_req.status_code == 200:
                ...
                place_phone = (
                        details_json['result']['international_phone_number'])
                # construct return statement with place name and phone number
